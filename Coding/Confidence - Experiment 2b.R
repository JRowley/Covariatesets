...
rm(Useful.count)
Useful <- PUMS80M[ , c("workedm", "morekids", "boys2", "multi2nd")]
rm(PUMS80M)
# =======================================================================================
# STEP 1
# =======================================================================================
...
Useful$X1 <- ifelse(Useful$boys2 == 0 | Useful$multi2nd == 1, 1, 0)
Useful$X2 <- ifelse(Useful$boys2 == 1 & Useful$multi2nd == 0, 1, 0)
