...
p + theme_bw() + 
  ...
  geom_rect(data=df2,aes(xmin=cl0,xmax=l0,ymin=cl1,ymax=cu1),fill="red",alpha=0.5) +
  geom_rect(data=df2,aes(xmin=u0,xmax=cu0,ymin=cl1,ymax=cu1),fill="red",alpha=0.5) +
  geom_rect(data=df2,aes(xmin=l0,xmax=u0,ymin=cl1,ymax=l1),fill="red",alpha=0.5) +
  geom_rect(data=df2,aes(xmin=l0,xmax=u0,ymin=u1,ymax=cu1),fill="red",alpha=0.5) +
