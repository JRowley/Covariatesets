...
Fourthly, the single equation model does not embed any restrictions that impose constraints on $g$.

Fifthly, the single equation model embeds the restriction that $U\independent (X,Z)$.

Sixthly, the single equation model embeds the restriction that $h$ is separable in $U$. 
...
%
%Firstly, the model embeds the restriction that $h$ is a non-parametric threshold crossing function (Restriction M4). This restriction consists of two parts: that $h$ is a threshold crossing function, and that the threshold is a non-parametric function of its arguments. 
%
%Restriction M1' particularly makes clear the relationship between $Y$ and $(D,X,Z,U)$, and so it is with reference to Restriction M1' through Restriction M6' that I discuss the credibility of the single equation model (rather than Restriction M1 through Restriction M6).
...
I discuss the credibility of the single equation model and the implications of the restrictions that it embeds for assumed behaviour.  


I discuss the credibility of the single equation model, focussing on Restriction M1' through Restriction M3'. I discuss the plausibility of Restriction 
%
%
