...
\end{Axiom}
\noindent I begin by introducing the non-parametric binary choice model that is described in \cite{cr13}. The model constitutes the set of structures that are consistent with Restriction \small{M}\normalsize{1} through Restriction \small{M}\normalsize{5}. 
