...
$\mathcal{K}$ is a large class, and it is not feasible to test Artstein's inequality for each $K\in\mathcal{K}$. A relevant question is whether it suffices to test Artstein's inequality for smaller class. \cite{crs13} show that 
%==================================================%
