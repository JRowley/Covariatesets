...
I write the expectation operator as $\mathbb{E}$, and the indicator function as $\mathbbm{1}$. To distinguish between population and sample quantities, I subscript sample quantities by $n$. 
...
I begin by introducing the non-parametric binary choice model that is described in \cite{cr13}. 
