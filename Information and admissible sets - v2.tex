...
\cmidrule(r){4-11}	
No. & &	$\mathcal{R}_Z$	&	&	$\theta_{n}^{0-}$	&	&	$\theta_n^{1-}$	&	&	$\theta_{n}^{0+}$	&	&	$\theta_n^{1+}$\\
\midrule
...
\cmidrule(r){4-7}	
No. & &	$\mathcal{R}_Z$	&	&	$\theta_{n}^{0-}$	&	&	$\theta_n^{1-}$	\\
\midrule
& &\phantom{$\text{Male-Female}\cup\text{Female-Male}\cup\text{Female-Female}$}\\
%6
