...
\subsubsection{Bias and the exclusion of $X$}
I discuss the bias that arises when individual behaviour is dependent upon $X$ but the simple single equation model is assumed. I show that assuming the simple single equation model does not identify a superset of the identified set for the single equation model. 




From the proof of (\ref{eq:ace}), the relationship between $r$ and $p$ is
