...
as the number of inequalities that describe the identified set. There is a clear curse of dimensionality.
\subsection{Computation} 
I describe an algorithm for determining those inequalities that describe the identified set. The algorithm is written with R \citep{R} functionality in mind, but may be adapted for other statistical packages.

Given the large numbers of inequalities for even small 
